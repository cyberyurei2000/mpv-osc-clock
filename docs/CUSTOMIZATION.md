...
|  `clock_format`       |  Set time format                                                              |        `%H:%M`         |  [Learn more](https://www.lua.org/pil/22.1.html); will be ignored if `formatsmp` is set         |
...
|  `date_format`        |  Set date format                                                              |      `%Y/%m/%d`        |  [Learn more](https://www.lua.org/pil/22.1.html)                                                |
